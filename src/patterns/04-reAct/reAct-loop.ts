...
async function withoutReAct() {
  ...
  const { text } = await generateText({
    ...
    tools: { getEmployee },
    instructions:
      'Eres un asistente de finanzas. Responde con los datos disponibles. Responde con los datos disponibles. Responde en español. Si no puedes encontrar el aprobador, responde con "No se puede aprobar el gasto."',
